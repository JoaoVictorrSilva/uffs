...
function Cc(){
  return (
    ...
    <nav>
      <ul>
        <BasicButtons curso='1º Semestre Vespertino'/>
        <BasicButtons curso='1º Semestre Noturno'/>
        <BasicButtons curso='2º Semestre Vespertino'/>
        <BasicButtons curso='3º Semestre Noturno'/>
        <BasicButtons curso='4º Semestre Vespertino'/>
        <BasicButtons curso='5º Semestre Noturno'/>
        <BasicButtons curso='6º Semestre Vespertino'/>
        <BasicButtons curso='7º Semestre Noturno'/>
        <BasicButtons curso='8º Semestre Vespertino'/>
        <BasicButtons curso='9º Semestre Noturno'/>
      </ul>
    </nav>
    </div>
